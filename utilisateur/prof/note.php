...
$curent=$row["id"];
    ...
    <td>{$fil['name']}</td>
    <td>
    <div class='d-flex'><a href='affecter.php?curent=$curent&id=$id' class='btn btn-primary mb-2 mr-2'>affecter notes</a>
                        <a href='modify.php?curent=$curent&id=$id' class='btn btn-warning mb-2 mr-2 text-black'>modify notes</a>
    </div>
    </td>
