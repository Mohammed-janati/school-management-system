...
ob_start();
?>
<a href="ajoutermodule.php?id=<?=$id?>&id_dep=<?=$id_dep?>"><button class="btn btn-primary mb-2">ajouter</button></a>
...
$curent=$row["id"];
    ...
    <td><div class='d-flex'><a href='modifymodule.php?id=$curent&idchef=$id&id_dep=$id_dep' class='btn btn-primary mb-2 mr-2'>modify</a>
    <a href='deletemodule.php?id=$curent&idchef=$id&id_dep=$id_dep' class='btn btn-danger mb-2 '>delete</a></div>
