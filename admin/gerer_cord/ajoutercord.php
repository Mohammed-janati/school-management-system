    ...
    <div class="row justify-content-center align-items-center h-100">
      ...
      <?php if(isset($_SESSION["succes"])) :?>
        ...
        <?php endif;?> 
              ...
              <?php endif;?>
            <form action="ajoutercord.php?id=<?= $id?>&id_dep=<?= $id_dep?>" method="post">
            ...
            <br>
              ...
              <a href="cord.php?id=<?= $id?>&id_dep=<?= $id_dep?>">
