...
<li class="nav-item ">
<?php
echo "   <a class='nav-link jsf' href='student.php?id={$id}&id_dep={$id_dep}'>
...
ob_start();
?>
<a href="ajouterstd.php?id=<?=$id?>&id_dep=<?=$id_dep?>"><button class="btn btn-primary mb-2">ajouter</button></a>
...
$curent=$row['id'];
    ...
    <td><div class='d-flex'><a href='modifystd.php?curent=$curent&id=$id&id_dep=$id_dep' class='btn btn-primary mb-2 mr-2'>modify</a>
    <a href='deletestd.php?curent=$curent&id=$id&id_dep=$id_dep' class='btn btn-danger mb-2 '>delete</a>
    </div>
