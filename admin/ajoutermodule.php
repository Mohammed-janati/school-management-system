...
$_SESSION["succes"]="module added successfully";
  ...
  header("location:ajoutermodule.php?id=$id&id_dep=$id_dep");
} 
    ...
    <div class="row justify-content-center align-items-center h-100">
      ...
      <?php if(isset($_SESSION["succes"])) :?>
        ...
        <?php endif;?> 
              ...
              <?php endif;?>
            <form action="ajoutermodule.php?id=<?= $id?>&id_dep=<?= $_GET["id_dep"]?>" method="post">
            ...
            <br>
              ...
              <a href="gerer_module.php?id=<?= $id?>&id_dep=<?= $id_dep?>">
